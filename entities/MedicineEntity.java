...
public class MedicineEntity implements Serializable {
	...
	private String maxPriceEighteenHalf;
	...
	public MedicineEntity(String cnpj, String laboratory, String code, String register, String ean1, String ean2,
						  ...
						  String maxPriceSeventeenHalfAlc, String maxPriceEighteen, String maxPriceEighteenHalf, String maxPriceTwenty,
	...
	public void addSubsTancies(String substance){substances.add(substance);}

	public void addAllSubstancies(List<String> substances){substances.addAll(substances);}
	...
	public String toString() {
		return "Substancia = " + substances + ", " + "CNPJ = " + cnpj + ", " + "Laborat�rio = " + laboratory + ", "
				+ "C�digo = " + code + ", " + "Registro = " + register + ", " + "ean1 = " + ean1 + ", " + "ean2 = "
				+ ean2 + ", " + "ean3 = " + ean3 + ", " + "Produto = " + product + ", " + "Apresenta��o = "
				+ apresentation + ", " + "Classe Terapeutica = " + terapeuticalClass + ", " + "Tipo de Produto = "
				+ productType + ", " + "Regime de Pre�os = " + priceType + ", " + "Pre�o final Sem Impostos = "
				+ finalPrice + ", " + "PF 0% = " + finalPriceZero + ", " + "PF 12% = " + finalPriceTwelve + ", "
				+ "PF 17% = " + finalPriceSeventeen + ", " + "finalPriceSeventeenAlc=" + finalPriceSeventeenAlc + ", "
				+ "finalPriceSeventeenHalf=" + finalPriceSeventeenHalf + ", " + "finalPriceSeventeenHalfAlc="
				+ finalPriceSeventeenHalfAlc + ", " + "finalPriceEighteen=" + finalPriceEighteen + ", "
				+ "finalPriceEighteenAlc=" + finalPriceEighteenAlc + ", " + "finalPriceTwenty=" + finalPriceTwenty
				+ ", " + "maxPriceZero=" + maxPriceZero + ", " + "maxPriceTwelve=" + maxPriceTwelve + ", "
				+ "maxPriceSeventeen=" + maxPriceSeventeen + ", " + "maxPriceSeventeenAlc=" + maxPriceSeventeenAlc
				+ ", " + "maxPriceSeventeenHalf=" + maxPriceSeventeenHalf + ", " + "maxPriceSeventeenHalfAlc="
				+ maxPriceSeventeenHalfAlc + ", " + "maxPriceEighteen=" + maxPriceEighteen + ", "
				+ "maxPriceEighteenHalf=" + maxPriceEighteenHalf + ", " + "maxPriceTwenty=" + maxPriceTwenty + ", "
				+ "hospitalarRestriction=" + hospitalarRestriction + ", " + "cap=" + cap + ", " + "confaz=" + confaz
				+ ", " + "icms=" + icms + ", " + "recursalAnalisys=" + recursalAnalisys + ", " + "tributaryCredit="
				+ tributaryCredit + ", " + "sellsInTwentyTwenty=" + sellsInTwentyTwenty + ", " + "stripe=" + stripe + ", " 
